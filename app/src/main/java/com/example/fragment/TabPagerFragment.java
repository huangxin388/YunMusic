...
public class TabPagerFragment extends AttachFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView search = view.findViewById(R.id.bar_search);
        ...
        //tabLayout.setTabTextColors(R.color.colorBlack, ThemeUtils.getThemeColorStateList(mContext, R.color.theme_color_primary).getDefaultColor());
